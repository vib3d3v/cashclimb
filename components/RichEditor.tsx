...
export default function RichEditor({ value, onChange }: Props) {
  const editor = useEditor({
    ...
    extensions: [
      ...
      Link.configure({
        openOnClick: false,
        // This is the key fix — override ALL rel attributes
        HTMLAttributes: {
          rel: null,        // ← removes nofollow noopener noreferrer
          target: '_blank',
        },
      }),
    ...
    editorProps: {
      attributes: {
        class: 'prose-cashclimb tiptap-editor min-h-[320px] outline-none p-4',
      },
    },
  })
